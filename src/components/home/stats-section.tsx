        ...
        <section className="py-24 relative overflow-hidden">
            ...
            <Container className="relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8 leading-[1.1]">
                        <span className="block text-blue-600 py-2">
                            Transforming
                        </span>
                        <span className="block text-gray-900 relative">
                            Education Worldwide
                            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-24 h-1.5 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full" />
                        </span>
                    </h2>
                ...
                <div className="text-center mt-16">
                    <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 to-sky-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
